...
REDLINE_TASKS: List[Tuple[str, float, float]] = [
    ...
    ('filter_bpf', 1e4, 2e3),
    ('filter_bpf', 1e5, 2e4),
    ('filter_notch', 1e4, 20.0),
    ('filter_notch', 1e5, 20.0),
]
...
def _run_redline_eval(
    *,
    ...
    cmd = [
        sys.executable,
        str(code_dir / "eval_filter_family.py"),
        "--base_model",
        str(base_model),
        "--adapter",
        str(adapter),
...
def main() -> int:
    ...
    while True:
        ...
        base_sp_cmd = [
            sys.executable,
            str(code_dir / "build_selfplay_filter_datasets.py"),
            "--base_model",
            str(args.base_model),
            "--adapter",
            str(cur_adapter),
        ...
        ppo_cmd = [
            sys.executable,
            str(code_dir / "train_ppo_filter.py"),
            "--base_model",
            str(args.base_model),
            "--sft_adapter",
            str(cur_after_pvpo),
